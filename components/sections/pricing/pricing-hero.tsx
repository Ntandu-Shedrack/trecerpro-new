  ...
  return (
    <motion.div
      ...
      className={`relative rounded-2xl border transition-all duration-300 ${
        plan.popular
          ? "border-primary/50 shadow-2xl shadow-primary/20 bg-gradient-to-br from-card to-primary/5 md:scale-105 z-20"
          ...
          {price !== null ? (
            <>
              ...
              <div className="flex flex-col">
                ...
                <span className="text-muted-foreground opacity-80 text-xs">billed annually</span>
              </div>
            </>
          ) : (
        ...
        <button
          className={`w-full py-3.5 rounded-xl font-semibold mb-10 transition-all duration-200 transform hover:scale-105 ${
            plan.popular
              ...
              : "bg-muted hover:bg-muted/80 text-foreground border border-transparent hover:border-border"
          }`}
        >
          {plan.cta}
        </button>
