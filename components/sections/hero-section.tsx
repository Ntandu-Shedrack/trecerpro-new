...
export default function HeroSection() {
  return (
    <section className="w-full bg-background md:px-20 py-24 overflow-hidden">
      <div className="container px-6 mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.h1
              variants={item}
              className="text-5xl md:text-6xl lg:text-7xl font-black text-foreground leading-[1.1] tracking-tight"
            >
          ...
          >
            ...
            >
              ...
              <div className="relative rounded-2xl border shadow-2xl overflow-hidden bg-card">
                ...
                <Image
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuBbSZk-a_AJut26YvVJCavsZonpDKc0n9weNU7uK1wpaaKK-sUPn37fGRFQoW0WK4teg8qKO7KcSHuHKOz6HbVCmqQxf18PWBDhsGeDr8Tm96U_znaO4UO1L3ez-f4RSKsm72_-ofeztoLN5CWmLveNxC3gEC-5BWJsgh_AEwrjf9w9XXA0inCOtXtTmbxVBWs--RjelZayoO7sfTpcCO7ZJyo9uk4yEQv32bInF728_N-AKZGN_2RMBoUyqEuD2_S3_Tn7UyaUR5wx"
