        ...
        <div className="space-y-6">
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-8 p-6 sm:p-8">
                    ...
                    <form onSubmit={handleUpdateProfile} className="space-y-6 flex flex-col justify-between">
                        <div className="space-y-4">
                            ...
                            {profileMsg && (
                                <div className={`p-4 rounded-xl flex items-center gap-2 border text-sm animate-in slide-in-from-top-1 duration-200 ${profileMsg.type === "success"
                        ...
                        <Button type="submit" disabled={profileLoading} className="bg-primary hover:bg-primary/90 text-primary-foreground font-semibold px-5 w-full mt-4">
                    ...
                    <form onSubmit={handleUpdatePassword} className="space-y-6 border-t md:border-t-0 md:border-l border-border/80 pt-6 md:pt-0 md:pl-8 flex flex-col justify-between">
                        <div className="space-y-4">
                            ...
                            {passwordMsg && (
                                <div className={`p-4 rounded-xl flex items-center gap-2 border text-sm animate-in slide-in-from-top-1 duration-200 ${passwordMsg.type === "success"
                                    ? "bg-emerald-500/10 text-emerald-600 border-emerald-500/20"
                                    : "bg-destructive/10 text-destructive border-destructive/20"
                                    }`}>
                        ...
                        <Button type="submit" disabled={passwordLoading} className="bg-primary hover:bg-primary/90 text-primary-foreground font-semibold px-5 w-full mt-4">
            ...
            <Card className="border border-border bg-card shadow-sm rounded-xl">
                ...
                <CardContent className="space-y-6 pt-4">
                    {twoFactorMsg && (
                        <div className={`p-4 rounded-xl flex items-center gap-2 border text-sm ${twoFactorMsg.type === "success"
                            ? "bg-emerald-500/10 text-emerald-600 border-emerald-500/20"
                            : "bg-destructive/10 text-destructive border-destructive/20"
                            }`}>
