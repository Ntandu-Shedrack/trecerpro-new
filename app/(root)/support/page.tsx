...
export default function ContactPage() {
  return (
    <main className="bg-background py-24 md:px-20">
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          ...
          >
            <Card className="p-8 bg-card rounded-xl border border-border shadow-sm">
            ...
            <motion.div
              ...
              className="relative rounded-xl overflow-hidden h-48 border border-border shadow-sm grayscale opacity-80 hover:grayscale-0 hover:opacity-100 transition-all"
            >
          ...
          >
            <Card className="p-8 bg-card lg:p-10 rounded-xl border border-border shadow-sm relative overflow-hidden">
